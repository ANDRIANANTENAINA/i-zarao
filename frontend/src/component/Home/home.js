        ...
        <div className="flex flex-row justify-between space-x-3 p-10">
            ...
            <div className="shadow-xl border-t rounded-xl w-2/3 h-screen pt-1 pl-1">
                <div className="card">
                    ...
                    <p className="text-indigo-800 hover:text-indigo-900 taille_title "> dolor sit amet, consectetur adipisicing elit. At commodi fugiat laboriosam, natus nemo</p>
                    <p className="text-gray-500 hover:text-gray-700 pl-2 taille">0 answers</p>
                    <div className="flex flex-row space-x-5 text-  ">
                        <p className="bg-amber-400 px-2 rounded hover:bg-amber-600 ">tag1</p>
                        <p className="bg-amber-400 px-2 rounded hover:bg-amber-600 ">tag1</p>
                        <p className="bg-amber-400 px-2 rounded hover:bg-amber-600 ">tag1</p>
                        <p className="bg-amber-400 px-2 rounded hover:bg-amber-600 ">tag1</p>
                    </div>
